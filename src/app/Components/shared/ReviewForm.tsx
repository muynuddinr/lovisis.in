        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-black focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500"
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-cyan-600 text-white py-2 rounded-lg hover:bg-cyan-700 disabled:opacity-50 transition-all duration-300"
          >
