...
export const defaultMetadata: Metadata = {
    ...
    keywords: [
        ...
        'Electrical Machine Trainer Kit',
        'DC Shunt Generator with Control Panel',
        'Motor Generator Set AC-DC with control Panel',
        'Motor Generator Set DC-AC with control Panel',
        'Cut section Model of Mock layout of a motor car –electrical system working model',
        'Demonstration board of electronic Ignition system, ignition coil',
        'Demonstration board of MPFI system',
        'Working Model of power windows',
        'Working Condition of Diesel Engine – CRDI - 4 stroke Engine, Assembly with fault simulation board',
        'Working Condition of Petrol MPFI Engine Assembly with fault simulation boar',
        'Air Bag Simulator',
